            ...
            columns: {
                identifier: function () {
                    ...
                    $td.each(function () {
                        ...
                        var span = '<span class="tabledit-span tabledit-identifier category">' + $(this).text() + '</span>';
...
let updateData = function () {
    $('.tabledit-span').each(function () {
        if (this.classList.contains("category")) {
            category.push(this.innerText);
        } else if (this.classList.contains("actual-amount")) {
            actualAmount.push(this.innerText);
        } else if (this.classList.contains("budget-amount")) {
            budgetAmount.push(this.innerText);
        }
    });
}
...
document.querySelector(".monthly-expenses_btn-update").addEventListener("click",function (e) {
    e.preventDefault();
